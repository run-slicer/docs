...
<div style="display: grid; grid-template-columns: 1fr 1.5fr; gap: 1rem;">
  <div style="display: flex; flex-direction: column; justify-content: space-between; gap: 1rem; padding-block: 1rem;">
    <div>
      slicer is a modern Java reverse engineering tool for the web, built with an emphasis on simplicity and convenience.
...
slicer is licensed under the [MIT License](https://github.com/run-slicer/slicer/blob/main/LICENSE), however it also includes components
