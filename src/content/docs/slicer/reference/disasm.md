...
| `outputdir`                  | String or null  | `null`                                                                                    | Decompile to files in [directory] (historic compatibility)                           |
| `outputpath`                 | String or null  | `null`                                                                                    | Decompile to files in [directory]                                                    |
| `outputencoding`             | String or null  | `null`                                                                                    | Saving decompiled files with specified encoding [encoding]                           |
...
| `dump-code-lines`                    | Boolean        | `0`                                                                                                                                                                                 | Dump line mappings to output archive zip entry extra data.                                                                                                                                        |
